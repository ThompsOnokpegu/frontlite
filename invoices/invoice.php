...
<style>
.teehead,.account{background:#3C7DA5; color:white;}
th,td{border-top:1px solid #aaaaaa;}
table,address{font-size:14px;}
<?php
...
<section class="content">
      <div class="container-fluid">
        <div class="row no-print">
            <div class="col-12">
              <a href=<?php echo "./print_invoice.php?invoice_ref=".$invoice['invoice_id']."&order_id=".$_SESSION['jobpages']; ?> target="_blank" class="btn btn-default"><i class="fas fa-print"></i> Print</a>
            </div>
        </div>
        <div class="row">
          <?php
